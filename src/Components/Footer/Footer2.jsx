          ...
          <div className="cs_bottom_footer_right" data-aos="fade-left">
            ...
            <div className="cs_footer_social_icons">
              {socialLinks.instagram && (
                <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="cs_footer_social_icon" aria-label="Instagram">
                  <Icon icon="fa6-brands:instagram" width="16" height="16" />
                </a>
              )}
              {socialLinks.facebook && (
                <a href={socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="cs_footer_social_icon" aria-label="Facebook">
                  <Icon icon="fa6-brands:facebook-f" width="16" height="16" />
                </a>
              )}
              {socialLinks.tiktok && (
                <a href={socialLinks.tiktok} target="_blank" rel="noopener noreferrer" className="cs_footer_social_icon" aria-label="TikTok">

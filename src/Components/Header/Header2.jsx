            ...
            <div className="cs_main_header_in">
              <div className="cs_main_header_left">
                <Link className="cs_site_branding" to={data.logoUrl}>
                  <span className="cs_logo_text">VJAFITNESS</span>
                </Link>
              </div>
                ...
                <div className="cs_header_icon_btns">
                  {socialLinks.instagram && (
                    <a
                      ...
                      className="cs_header_icon_btn cs_social_icon cs_center"
                  ...
                  {socialLinks.tiktok && (
                    <a
                      ...
                      aria-label="TikTok"
                    >
                      <Icon icon="fa6-brands:tiktok" width="18" height="18" />
                    </a>
                  )}
                  <Link to="#" className="cs_header_icon_btn cs_center">
                    <svg
                      width={20}
                      height={20}
                      viewBox="0 0 20 20"
